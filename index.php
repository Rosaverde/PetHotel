		...
		<div class="row">
			<div class="col-lg-12">
				<div id="landing">
					...
					<hr>
                    <a href="reservation" class="btn btn-default btn-lg" ><i class="fas fa-paw"></i> Book A Day</a>
                    <div class="landing-text">
                        <p>
                            At Purrrfect Pet Care Hotel we provide an all-inclusive service for every part of your pet’s life. 
